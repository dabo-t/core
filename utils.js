...
//  }
  ...
  tempHTML = tempHTML.replace(/<span class="url-icon"><img alt=(.*?) src="(.*?)" style="width:1em; height:1em;" \/><\/span>/g,' $1 ');
  //图片评论处理
  tempHTML = tempHTML.replace(/<a data-url="http:\/\/t.cn\/(.*?)" href="(.*?).jpg" data-hide=""><br>\u67e5\u770b\u56fe\u7247<\/a><br><br><div style="border-left: 3px solid gray; padding-left: 1em;">/g,'<br><a href="$2.jpg" style="color:#09f!important;text-decoration:none !important;">查看图片</a><br><img src="$2.jpg" width="500"><br><br><div style="border-left: 3px solid gray; padding-left: 1em;">');
  tempHTML = tempHTML.replace(/<a href="(.*?)" data-hide=""><br>\u67e5\u770b\u56fe\u7247<\/a>/g,'<br><a href="$1">查看图片 </a><br><img src="$1" referrerpolicy="no-referrer" width="800">'); 
  //链接图标处理
